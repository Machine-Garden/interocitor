...
if (!generated) throw new Error("Encrypted chat bundle generation produced no output");

if (check) {
  const committed = await readFile(outputPath);
  if (!committed.equals(generated)) {
    throw new Error("docs/examples/chat/app.js is stale; run yarn build:docs:chat");
  }
} else {

...
function withOptional<T, K extends import('./types.ts').SchemaFieldKind>(field: SchemaField<T, K>): BaseField<T, K> {
...
export const types = {
  string:  withOptional({ kind: 'string'  } as IndexableSchemaField<string>) as BaseIndexableField<string>,
  number:  withOptional({ kind: 'number'  } as IndexableSchemaField<number>) as BaseIndexableField<number>,
  boolean: withOptional({ kind: 'boolean' } as IndexableSchemaField<boolean>) as BaseIndexableField<boolean>,

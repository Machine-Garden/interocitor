...
| await mesh.compact() | Publishes a snapshot, removes its exactly covered change files, and retains tombstones. Designate one checkpoint writer per managed mesh. |
